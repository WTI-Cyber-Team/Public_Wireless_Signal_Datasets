...
params(2).phase_offset = 0;
params(2).initial_CFO = 0;
...
params(4).phase_offset = 0;
params(4).initial_CFO = 0;
...
params(5).phase_offset = 0;
params(5).initial_CFO = 0;
